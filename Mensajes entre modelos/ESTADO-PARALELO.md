...
|-------|--------|----------|--------|--------|-----|
| Inputs direccionales duplicados en host | DeepSeek | `retroarch/netplay_optimized.cfg`, `Mensajes entre modelos/inputs-direccionales-duplicados/` | no resuelto | 2026-07-04 05:59 | - |
