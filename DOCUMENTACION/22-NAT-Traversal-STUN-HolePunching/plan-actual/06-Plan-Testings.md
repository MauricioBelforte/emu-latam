...
## Resultados (ver 07-Resultados-Testings.md)

- [x] UT-01 a UT-06: 100% pasan (37/37)
- [x] IT-01: Hole punch localhost exitoso
- [ ] IT-03: Fallback a bore sin crash (pendiente prueba WAN real)
- [x] Regresión: test_stable_flows.js 50/51
- [x] Build: npm run dev sin errores
