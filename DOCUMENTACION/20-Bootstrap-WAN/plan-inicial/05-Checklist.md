...
| 3.3 | Agregar UI: botón "SALA PÚBLICA" + input room code + estado | 🟡 Media | `App.tsx` | 🔲 |

## Fase 4: Tests

| # | Tarea | Prioridad | Archivo | Estado |
|:--|:------|:----------|:--------|:-------|
| 4.1 | Crear `test_bootstrap.js` con mocks HTTP | 🔴 Alta | `client/test_bootstrap.js` | 🔲 |
| 4.2 | Test 1: publishBoreUrl con mock dpaste response | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.3 | Test 2: fetchBoreUrl con room code válido | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.4 | Test 3: fetchBoreUrl con room code inválido (404) | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.5 | Test 4: dpaste timeout | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.6 | Test 5: StartNakamaBore simulado | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.7 | Test 6: BootstrapClose sin nada activo (no crash) | 🟡 Media | `test_bootstrap.js` | 🔲 |
| 4.8 | Test 7: Regresión — build TypeScript | 🟡 Media | `test_bootstrap.js` | 🔲 |
...
| 5.2 | Tests pasan (test_bootstrap.js) | 🔴 Alta | 🔲 |
