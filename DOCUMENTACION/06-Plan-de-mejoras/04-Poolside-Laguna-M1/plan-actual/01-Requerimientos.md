...
1. **Redundancia en orquestación**: Los handlers de "Host con Bore" requieren dos pasos manuales (HOST GAME + JOIN GAME) para funcionar correctamente. El flujo propuesto debe unificar esto en una sola operación automática.
